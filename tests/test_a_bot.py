...
if __name__ == "__main__":
    ...
    if True:
        ...
        assistant.api("add note", "Note 3", "#tag1", "#tag2", verbose=verbose)
        assistant.api("add note", "Note 4", "#tag2", "#tag3", verbose=verbose)
        assistant.api("add note", "Note 5", "#tag2", "#tag3", verbose=verbose)
        assistant.api("add note", "Note 5", "#tag2", "#tag3", verbose=verbose)
        assistant.api("add note", "Note 6", "#tag1", "#tag2", verbose=verbose)
        assistant.api("add note", "Note 7", "#tag1", "#tag2", verbose=verbose)
        assistant.api("add note", "Note 8", "#tag1", "#tag2", verbose=verbose)
        assistant.api("add note", "Note 9", "#tag2", "#tag3", verbose=verbose)
        assistant.api("add note", "Note 10", "#tag2", "#tag3", verbose=verbose)
        assistant.api("add note", "Note 11", "#tag2", "#tag3", verbose=verbose)
        assistant.api("add note", "Note 11", "#tag2", "#tag3", verbose=verbose)
